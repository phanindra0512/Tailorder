...
function CompletedOrders({navigation}) {
  ...
  useEffect(() => {
    const todayOrders = async () => {
      ...
      const orderByStatus = orders.filter((d) => {
        return d.orderDetails.orderStatus == 'READY';
      });
  ...
  const onChangeSearch = (text) => {
    setIsSearchOrders(
      isOrders.filter((i) =>
        i.orderDetails.custId.toLowerCase().includes(text.toLowerCase()),
      ),
    );
  };
  ...
  return (
    <View style={styles.container}>
      <CustomHeader title="Completed Orders" />
      {isLoader ? (
              ...
              {dateVis ? (
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text style={[styles.subheading, {color: '#2E8BFA'}]}>
                      View All
                    </Text>
                  </TouchableOpacity>
                </View>
                    ...
                    <View style={styles.orderContainer}>
                      <View style={styles.detailBlock}>
                        <View>
                          <Text
                            numberOfLines={1}
                            style={[styles.heading, {width: 170}]}>
                      ...
                      <View style={{flexDirection: 'row', paddingLeft: 13}}>
                        {orderItem.orderDetails.itemDetails.map(
                          (item, index) => {
                            return (
                              <Text
                                key={index}
                      ...
                      <View style={{flexDirection: 'row', paddingVertical: 10}}>
                        ...
                        <View
                          style={[styles.statusBlock, {borderRightWidth: 0}]}>
